...
import 'package:power_on_hand/ui/screens/laporan_lapangan_detail_screen.dart';
...
class _LaporanListItemState extends State<LaporanHarianListItem> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Get.to(() => LaporanLapanganDetailScreen(widget.harian.id));
      },
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Spacer(),
            RoundedChipColor(text: widget.harian.name, color: Color(0xFF3DB9FF)),
            Spacer(),
            RoundedChipColor(
