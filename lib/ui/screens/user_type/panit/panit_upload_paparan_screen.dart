...
class PanitUploadPaparanScreen extends StatefulWidget {
  @override
  _PanitUploadPaparanScreenState createState() => _PanitUploadPaparanScreenState();
}

class _PanitUploadPaparanScreenState extends State<PanitUploadPaparanScreen> {
