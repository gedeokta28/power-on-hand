...
class KasubditUploadKasusScreen extends StatefulWidget {
  @override
  _KasubditUploadKasusScreenState createState() => _KasubditUploadKasusScreenState();
}

class _KasubditUploadKasusScreenState extends State<KasubditUploadKasusScreen> {
